...
def js_math(transfer_function, context, num_points = 5000):
    #Circuit Parameters
...
def generate_bode(analyzed_circuit_object, context, num_points = 5000):
    """
    ...
    bode_x_range_output_impedance, mags_output_impedance, phases_output_impedance = js_math(output_impedance, context, num_points)
    ...
    bode_x_range_input_impedance, mags_input_impedance, phases_input_impedance = js_math(input_impedance, context, num_points)
    ...
    bode_x_range_input_output_transfer, mags_input_output_transfer, phases_input_output_transfer = js_math(input_output_transfer, context, num_points)
    ...
    bode_x_range_duty_output_transfer, mags_duty_output_transfer, phases_duty_output_transfer = js_math(duty_output_transfer, context, num_points)
